...
md`# Pixstory Bar Chart Race`
)}

function _data(FileAttachment){return(
FileAttachment("interests_covid_race.csv").csv({typed: true})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["interests_covid_race.csv", {url: new URL("./files/f5f6f6fb80759f88a1f169bea0f11021176d4693328dfb99ac62a9f44170bb9b1ab8d74cb519e1d6f9d53e0c17a6fbe77e86bc9a6d5b96c150562efc59c71835.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
